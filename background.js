...
chrome.contextMenus.onClicked.addListener((clickData, tab) => {
	if (clickData.menuItemId == 'searchThesarusCom') {
		// https://www.thesaurus.com/browse/${clickData.selectionText}
		chrome.tabs.create({
			url: new URL(
				`https://www.thesaurus.com/browse/${clickData.selectionText}`
			).toString(),
...
function createContextMenus(res) {
	...
	chrome.contextMenus.create({
		id: 'searchThesarusCom',
		title: 'Search thesarus.com',
		contexts: ['selection'],
		type: 'normal',
		parentId: 'showSynonyms',
	});
...
function createMainParent() {
	...
	chrome.contextMenus.create(
		...
		() => {
			// console.log(pluralize.singular('answers'));
			if (chrome.runtime.lastError) console.log(chrome.runtime.lastError);
		}
	);
}

// taken from https://github.com/plurals/pluralize/blob/master/pluralize.js
pluralize = (function () {
